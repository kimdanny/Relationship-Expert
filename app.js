...
var app = express();
var nextResponseShouldAdvise = "false";
...
function sendHiMessage(recipientId) {
  ...
  nextResponseShouldAdvise = "true";
}



function sendSecondMessage(recipientId, messageText) {
  ...
  var messageData = {
    ...
    message: {
      //text: `This is my second response to you. I'll change it to something else soon.`
      text: response
    }

    
  }
  nextResponseShouldAdvise = "false";
  callSendAPI(messageData);
  });
